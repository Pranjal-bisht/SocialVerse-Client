...
(JWT) with RSA cryptographic algorithm.<br/>
• Used Cloudinary API for uploading and storing images on the cloud.<br/>
• For database, Used MongoDB atlas with mongoose ORM and deployed the web app on Heroku.<br/>
